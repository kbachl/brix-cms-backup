 ...
 * the url. To facilitate that this panel implements {@link org.brixcms.web.nodepage.PageParametersAware} which is a Brix interface that includes
 * url related callbacks to make manual state management easier.
 * <p/>
 * See {@link #initializeFromPageParameters(org.brixcms.web.nodepage.BrixPageParameters)} and {@link #contributeToPageParameters(org.brixcms.web.nodepage.BrixPageParameters)}
