    ...
    private void initDefaultWorkspace() {
        try {
            ...
            if (!sp.siteExists(wn, defaultState)) {
                ...
                System.out.print("resource: ../resources/initialWorkspace.xml : " + getClass().getResourceAsStream("../resources/defaultDemoWorkspace.xml"));

                session.importXML("/", getClass().getResourceAsStream("../resources/defaultDemoWorkspace.xml"),
            ...
            throw new RuntimeException("Could not initialize jcr workspace with Brix", e);
        }
    }
